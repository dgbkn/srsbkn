...
class ArtistSongs extends StatefulWidget {
  ...
  const ArtistSongs({required this.artist_id, required this.artist_name});
...
class _ArtistSongsState extends State<ArtistSongs> {
  ...
  Future loadData() async {
    ...
    var data = await http
        .get(getApiUrl("getartistsongs.php?artist_id=${widget.artist_id}"));
